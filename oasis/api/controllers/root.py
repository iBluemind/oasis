...
from oasis.api.controllers import v1
from oasis.api.controllers import versions
...
class Root(base.APIBase):
    ...
    def convert():
        root = Root()
        root.name = "OpenStack oasis API"
        root.description = ("oasis management.")
...
class RootController(rest.RestController):
    ...
    def _route(self, args):
        ...
        It redirects the request to the default version of the oasis API
